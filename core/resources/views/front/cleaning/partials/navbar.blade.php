                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="top_right d-flex">
                            @if (!empty($currentLang) && count($langs) > 1)
                                <ul class="top-header-language" hidden>
                            ...
                            @guest
                                @if ($bex->is_user_panel == 1)
                                    <ul class="login text-bold">
                                        <li style="color:#fff;"> <a href="{{route('user.login')}}"><i  style="color:#D53021;" class="fa fa-user"></i><b> {{__('login')}}</b></a></li>
                                    </ul>
                                @endif
                            @endguest
            ...
            <div class="container-fluid">
                <div class="row align-items-center position-relative">
                    <div class="col-lg-2 col-6">
                        <div class="logo">
                            <a style="width:140px;" href="{{route('front.index')}}"><img data-src="{{asset('assets/front/img/'.$bs->logo)}}" class="img-fluid lazy" alt=""></a>
                        </div>
                    </div>
                    <div class="col-lg-10 col-6">
                        <div class="header-menu-area">
                            ...
                            @if (!empty($currentLang) && count($langs) > 1)
                                <li class="menu-item-has-children">
                                <span ><i class="fas fa-globe"></i>  {{convertUtf8($currentLang->name)}}  <i class="fa fa-angle-down"></i></a></span>
                                <ul class="sub-menu">
                                    <li><a href="#">
                                            @foreach ($langs as $key => $lang)
                                                <li><a href='{{ route('changeLanguage', $lang->code) }}'>{{convertUtf8($lang->name)}}</a></li>
                    ...
                    <div class="col-sm-12 position-static"><div class="mobile_menu" style="overflow:hidden;"></div></div>
                </div>
            </div>
        </section>
    </header>
