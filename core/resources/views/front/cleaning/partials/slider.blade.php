        ...
        <div class="hero-carousel-active">
            @if (!empty($sliders))
                @foreach ($sliders as $key => $slider)
                    <div class="single-carousel-active lazy" data-bg="{{asset('assets/front/img/sliders/'.$slider->image)}}" style="background-size:contain;background-position:center;background-size: 100%;">
                        <div class="container">
                            <div class="row">
